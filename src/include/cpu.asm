...
high_expansion_memory_end   equ >0000 ; Actually >10000.

* Macro: Skip from the current 8K code memory bank to the start of the next
* one.
    .defm next_bank
    bss >2000 - ($ & >1fff)    ; Careful: only signed 16-bits computations.
    .endm
...
* IN #1: the start address of the source block.
